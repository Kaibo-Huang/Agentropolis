 ...
 */
export function computeDailyUpdate(state) {
    const { population, economy, publicHealth, housingCost, pollution, publicOpinion, } = state;
    ...
    const opinionDrift = (economy + publicHealth) * INFLUENCE * 0.3 -
