/**
 * Three.js 3D Toronto scene for the frontend.
 * Imports simulation state type from the genai-genesis engine package.
 */
import * as THREE from "three";
import { OrbitControls } from "three/examples/jsm/controls/OrbitControls.js";
import type { CityState } from "genai-genesis";

// (Body copied from existing src/world/toronto-scene.ts, only the CityState import differs.)
